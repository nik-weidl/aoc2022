...
int main() {
    ...
    while ((c = getchar()) != EOF) {
        ...
        if((c == 'X' || c == 'Y' || c == 'Z') && attack != 0){
            if(attack == 'A'){ // rock
                if(c == 'X') roundresult = 1+3; // draw
                else if(c == 'Y') roundresult = 2+6; // win
                else if(c == 'Z') roundresult = 3+0; // lose
            }
                ...
                if(c == 'X') roundresult = 1+6; // win
                else if(c == 'Y') roundresult = 2+0; // lose
                else if(c == 'Z') roundresult = 3+3; // draw
            }
            result += roundresult;
            attack = 0;
        }
